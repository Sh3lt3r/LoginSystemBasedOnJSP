...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-reg w-100 m-auto">
        ...
        <form action="../register/table" method="post">
            ...
            <div class="form-floating">
                <input type="password" name="repassword" class="form-control" id="floatingPassword2" placeholder="rePassword">
                <label for="refloatingPassword">rePassword</label>
            </div>
        ...
        <div style="margin-top: 10px;"></div>
        <h1 style="font-size: 16px;">${RegPrompt}</h1>
